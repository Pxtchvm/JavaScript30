...
const inventorsYears = inventors.reduce(
...
const inventorsYearsLived = inventors.sort(
...
const deOnly = de.filter((de) => de.includes("de")); */

// 7. sort Exercise
// Sort the people alphabetically by last name

const peopleSorted = people.sort((lastName, firstName) => {
  let [last, first] = lastName.split(", ");
  let [lastNext, firstNext] = firstName.split(", ");
